...
$(document).ready( function() {
	...
	Janus.init({debug: "all", callback: function() {
		...
		$('#wlcmBuddy').html('Welcome ' + getUserName());
						...
						janus.attach(
							{
								...
								success: function(pluginHandle) {
									...
									$('#createroom').click(function(){
                                        $('#registernow').addClass('hide').hide();
                                        $('#create').removeClass('hide').show();
                                    });
                                    $('#joinroom').click(function() {
                                        $('#registernow').addClass('hide').hide();
                                        $('#join').removeClass('hide').show();
                                    });
                                    $('#addbtn').click(createRoom);
                                    $('#joinbtn').click(registerUsername);
									$('#username').focus();
								...
								onmessage: function(msg, jsep) {
									...
									if(event) {
										if(event === "created") {
											Janus.log("HA FUNZIONATO: " + new_room_name + "; msg: " + msg['room']);
...
function registerUsername() {
	...
	if (myroom === null || myroom === undefined || myroom === "") {
		myroom = parseInt($('#chooseroom').val());
	}

	$('#actual_room').val(myroom);
